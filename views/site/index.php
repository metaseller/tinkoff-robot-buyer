...
echo Html::tag('h1', 'PHP Robot Buyer base on TInvest API');
...
<center>Неофициальный PHP фреймворк для T-Invest API: <a href="https://github.com/metaseller/tinkoff-invest-api-v2-php">metaseller/tinkoff-robot-buyer</a></center>
