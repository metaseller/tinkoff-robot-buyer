...
use app\components\formatters\Formatter;
use Yii;
...
class NumbersHelper
{
    ...
    /**
     * Метод переводит рубли в копейки с округлением до меньшего
     *
     * @param float $money Сумма в рублях
     *
     * @return int Сумма в копейках
     */
    public static function rubbleToPenny(float $money): int
    {
        return (int) floor(100 * $money);
    }
}
